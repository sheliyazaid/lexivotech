...
export function ContactCTA() {
  return (
    <section className="relative py-20 md:py-32 px-6 md:px-10 bg-bone overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto text-center">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-4">
          <MagneticButton href="/contact" className="inline-flex items-center justify-center gap-3 w-[220px] px-8 py-5 rounded-full bg-ink text-bone font-body uppercase tracking-[0.25em] text-[12px]">
            Start a project <ArrowUpRight size={16}/>
          </MagneticButton>
          <MagneticButton href={`mailto:${CONTACT.email}`} className="inline-flex items-center justify-center gap-3 w-[220px] px-8 py-5 rounded-full border border-ink/25 text-ink font-body uppercase tracking-[0.25em] text-[12px] hover:border-ink">
            {CONTACT.email}
          </MagneticButton>
        </div>
      </div>
